...
#       every time this endpoint is hit (e.g., on dashboard refresh).
#     """
#     try:
...
#         # ===== NEW: log to blockchain + firebase =====
...
# # ===== RATE LIMIT CONFIG =====
# # max 1 blockchain/Firebase log every N seconds
...
# # Globals for rate limiting state
# last_forecast_log_ts = 0.0
# rate_limit_lock = Lock()


# def check_rate_limit():
#     """
#     Simple in-memory rate limit for *logging* to blockchain + Firebase.
#     Allows one log every LOG_RATE_LIMIT_SECONDS seconds.

#     Returns:
#         allowed (bool), cooldown_remaining (float seconds)
#     """
#     global last_forecast_log_ts
#     now = time.time()
#     with rate_limit_lock:
#         elapsed = now - last_forecast_log_ts
#         if elapsed < LOG_RATE_LIMIT_SECONDS:
#             return False, LOG_RATE_LIMIT_SECONDS - elapsed
#         # update last log time
#         last_forecast_log_ts = now
#         return True, 0.0
...
#         • ForecastLogger smart contract on Ganache
#         • Firebase Firestore (forecast_logs collection)
#       but now with rate limiting (LOG_RATE_LIMIT_SECONDS).
#     """
#     try:
#         # Ensure pipeline artifacts exist; normally already done at startup
#         if (
...
#         # ===== NEW: log to blockchain + firebase with rate limiting =====
#         blockchain_meta = None
#         rate_limit_info = {
#             "active": False,
#             "cooldownSeconds": 0
...
#             "rateLimit": {
#                 "active": False,
#                 "cooldownSeconds": LOG_RATE_LIMIT_SECONDS
#             }
#         }), 200
